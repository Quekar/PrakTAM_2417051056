...
private val categoryOptions = listOf(
    CategoryOption("Kuliah",  Color(0xFF3B82F6), "#3B82F6", "📚"),
    CategoryOption("Pribadi", Color(0xFF22C55E), "#22C55E", "🏃"),
    CategoryOption("Kerja",   Color(0xFFF59E0B), "#F59E0B", "💼"),
    CategoryOption("Penting", Color(0xFFEF4444), "#EF4444", "🔴"),
    CategoryOption("Lainnya", Color(0xFF8B5CF6), "#8B5CF6", "📌"),
)
        ...
        Column(
            ...
            Row(
                ...
                Column {
                    ...
                    Text(
                        text     = "Isi detail jadwal baru kamu",
                        fontSize = 12.sp,
            ...
            FormLabel(text = "Judul Kegiatan", required = true)
            ...
            OutlinedTextField(
                ...
                colors        = inputColors(),
                leadingIcon   = {
                    Text(text = selectedCat.emoji, fontSize = 18.sp,
            ...
            FormLabel(text = "Tanggal", required = true)
            Spacer(modifier = Modifier.height(6.dp))
            PickerButton(
                icon    = "📅",
            ...
            AnimatedContent(
                ...
                Row(
                    ...
                    Text(
                        text       = if (isError) "Jam selesai tidak boleh sebelum jam mulai"
                        else "Durasi: $dur",
                        fontSize   = 12.sp,
                        color      = if (isError) Color(0xFFEF4444) else Color(0xFF4F46E5),
                        fontWeight = FontWeight.SemiBold
                    )
                }
            }
            ...
            FormLabel(text = "Deskripsi (opsional)")
            Spacer(modifier = Modifier.height(6.dp))
            OutlinedTextField(
                value         = description,
            ...
            Row(
                ...
                OutlinedButton(
                    ...
                    Text(text = "Batal", fontWeight = FontWeight.SemiBold, fontSize = 14.sp)
                }
...
private fun computeDurationMinutes(start: String, end: String): Int {
    return try {
        val s = LocalTime.parse(start)
        val e = LocalTime.parse(end)
        java.time.Duration.between(s, e).toMinutes().toInt().coerceAtLeast(0)
